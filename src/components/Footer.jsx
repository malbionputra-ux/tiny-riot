        ...
        <div className="footer-bottom">
          ...
          <div className="footer-socials">
            <a 
              ...
              onMouseLeave={() => setCursorVariant('default')}
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="social-svg-icon">
            ...
            <a 
              ...
              onMouseLeave={() => setCursorVariant('default')}
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="social-svg-icon">
